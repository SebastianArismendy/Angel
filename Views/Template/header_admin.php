...
<html lang="es">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard"><img class="logo_admin" src="<?= media() ?>/tienda/images/logo_oscuro.png" alt="Logo Angel"/></a>
